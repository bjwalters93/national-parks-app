export const parkIdentification = [
  {
...
//   parkData.data.map((park: any) =>
//     x.push({ fullName: park.fullName, parkCode: park.parkCode })
//   );
...
// getPark(
//   "https://developer.nps.gov/api/v1/parks?limit=1000&api_key=9JlgO9YSfRlkWXenMR8S3X3uW9uW0cZBdycA46tm"
// );
